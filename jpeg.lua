...
static const int BITS_IN_JSAMPLE = 8;   /* use 8 or 12 */
...
static const int MAX_COMPONENTS  = 10;  /* maximum number of image components */
...
static const int JPEG_MAX_DIMENSION = 65500;  /* a tad under 64K to prevent overflows */
...
static const int RGB_RED       = 0; /* Offset of Red in an RGB scanline element */
static const int RGB_GREEN     = 1; /* Offset of Green */
static const int RGB_BLUE      = 2; /* Offset of Blue */
static const int RGB_PIXELSIZE = 3; /* JSAMPLEs per RGB scanline element */
...
static const int JPEG_LIB_VERSION        = 80;
static const int JPEG_LIB_VERSION_MAJOR  = 8;
static const int JPEG_LIB_VERSION_MINOR  = 4;
...
static const int DCTSIZE           = 8;  /* The basic DCT block is 8x8 coefficients */
 ...
 */
static const int C_MAX_BLOCKS_IN_MCU = 10; /* compressor's limit on blocks per MCU */
static const int D_MAX_BLOCKS_IN_MCU = 10; /* decompressor's limit on blocks per MCU */
...
static const int JDCT_FASTEST = JDCT_IFAST;
...
static const int JMSG_LENGTH_MAX = 200;

static const int JMSG_STR_PARM_MAX = 80;
...
static const int JPOOL_PERMANENT = 0;   /* lasts until master record is destroyed */
static const int JPOOL_IMAGE     = 1;   /* lasts until done with image/datastream */
static const int JPOOL_NUMPOOLS  = 2;
...
static const int JPEG_RST0 = 0xD0; /* RST0 marker code */
static const int JPEG_EOI  = 0xD9; /* EOI marker code */
static const int JPEG_APP0 = 0xE0; /* APP0 marker code */
static const int JPEG_COM  = 0xFE; /* COM marker code */
...
function jpeg.jpeg_create_compress(cinfo)
   return jpeg.jpeg_CreateCompress(cinfo,
                                   jpeg.JPEG_LIB_VERSION,
                                   ffi.sizeof("struct jpeg_compress_struct"))
end

function jpeg.jpeg_create_decompress(cinfo)
   return jpeg.jpeg_CreateDecompress(cinfo,
                                     jpeg.JPEG_LIB_VERSION,
